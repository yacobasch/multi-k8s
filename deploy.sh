...
kubectl set image deployment/client-deployment client=yacaschdkr20/multi-client
kubectl set image deployment/server-deployment server=yacaschdkr20/multi-server
kubectl set image deployment/worker-deployment worker=yacaschdkr20/multi-worker